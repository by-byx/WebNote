...
1. 如何让多个盒子(div)水平排列成一行？
   ...
   ![03_水平排列div](https://i.loli.net/2020/12/05/rzbeKY23IL9SwuF.png)

2. 如何实现盒子的左右对齐？

   ![float1](https://i.loli.net/2020/12/05/Y1nAK8M9LaxEXfm.png)
...
3. 浮动最早是用来**控制图片**，实现**文字环绕图片的效果**。
   ...
   ![01_文字环绕示意图](https://i.loli.net/2020/12/05/DLvpHqZ7K5chu4b.png)
...
浮动——浮~浮~浮~~~漂浮在普通流的上面。  脱离标准流。 俗称 “脱标”   
 ...
 ![23浮动脱标](https://i.loli.net/2020/12/05/dhlESVZ2eCIsKDo.png)
...
![zou](https://i.loli.net/2020/12/05/OCDrWTMmY3SwFa8.gif)
...
```
 ...
 ![24浮动一行显示](https://i.loli.net/2020/12/05/pu6iEklW5oBJRj8.png)
...
![mii](https://i.loli.net/2020/12/05/UTiqBrk8LuJpPFM.png)

#### 导航栏案例

![nav](https://i.loli.net/2020/12/05/NRq67XkhovMLKG2.png)
...
- 不会与父盒子的边框重叠，也不会超过父盒子的内边距
  ...
  ![05_父子盒子关系示意图](https://i.loli.net/2020/12/05/cJhlY7OZTMK3v8o.png)
...
> 浮动只会影响当前的或者是后面的标准流盒子，不会影响前面的标准流。
 ...
 ![two1](https://i.loli.net/2020/12/05/oiltPQYCerF4ygn.jpg)
...
![n](https://i.loli.net/2020/12/05/i6Pluzxg5mcFefa.jpg)



![no](https://i.loli.net/2020/12/05/n2cp7zyMPrmB51U.jpg)
...
![163](https://i.loli.net/2020/12/05/QSUWKzrij2XY4vk.png)
...
### 1). PS切片工具
 ...
 ![1498466173246](https://i.loli.net/2020/12/05/CVgcXdUlpoFT52Q.png)
...
* 利用辅助线 来切图 --    基于参考线的切片 
   ...
   ![1498466734205](https://i.loli.net/2020/12/05/eouWmJ26zjxQNdH.png)
...
![sample1](https://i.loli.net/2020/12/05/6zOZnV4yhTQpXFj.gif)
